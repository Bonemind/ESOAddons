WF_CONSTANTS.FindGameImage = function( txt, dumpToChat )
	local lst = {}
	for _,v in pairs(WF_CONSTANTS.GameImages) do
		if string.find(v, string.lower(string_trim(txt))) then 
			lst[table_next(lst)] = v
